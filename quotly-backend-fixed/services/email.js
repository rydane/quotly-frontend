...
const EMAIL_FROM     = process.env.EMAIL_FROM      || `Quotly <${BREVO_USER}>`;
...
function createTransport() {
  if (!BREVO_USER || !BREVO_PASS) {
    throw new Error('[Email] BREVO_USER ou BREVO_PASS manquant dans les variables d\'environnement.');
  }
